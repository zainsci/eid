...
import EidText from "components/svgs/eid.svg"
import MubarakText from "components/svgs/mubarak.svg"
import StarIcon from "components/svgs/star.svg"
import MoonIcon from "components/svgs/moon.svg"
import StarShape01 from "components/svgs/star01.svg"
import StarShape02 from "components/svgs/star02.svg"
          ...
          <div className="w-full h-full text-5xl md:text-7xl font-display z-10 flex flex-col justify-center items-center">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="relative w-44 md:w-60 h-auto flex justify-center items-start">
                ...
                <div className="absolute md:relative top-0 right-0 text-teal">
                  <Star />
                </div>
              </div>
...
export function Star01() {
  return (
    <motion.div
      className="absolute top-0 right-0 text-purple-600 md:text-teal opacity-60 flex justify-center items-center w-full h-full"
      style={{
        minWidth: "30rem",
        minHeight: "30rem",
        maxWidth: "60vw",
...
export function Star02() {
  return (
    <motion.div
      className="absolute bottom-0 left-0 opacity-60 flex justify-center items-center w-full h-full text-purple-400 md:text-yellow"
      style={{
        minWidth: "20rem",
        minHeight: "20rem",
        maxWidth: "40vw",
